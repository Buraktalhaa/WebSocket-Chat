import { hideForm, openDisabled, hideAllButtons, cancelBtn } from "./ui.js";
...
newUserButton.addEventListener("click", (event) => {
    ...
    console.log("Web Connection start..")
          
    // If click the cancel button
    cancelBtn(cancelButton , userName)
    ...
    sendNameButton.addEventListener('click', (event1) => {
        ...
        cancelBtn(cancelChannelButton , channelName)
    ...
    ws.onmessage = (event) => {  
        ...
        try {
            ...
            // You are alone in channel
                ...
                messageElement.textContent = `[${from}]: ${parsedValue.text}`
                messageElement.classList.add('text-server')
                messageBox.appendChild(messageElement)
            }
            ...
            // MY OWN MESSAGES
                ...
                editButton.addEventListener("click", () => {
                    ...
                    // When the editing process is canceled
                    if (editedMes === null) {
